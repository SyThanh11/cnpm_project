    ...
    <div className="PrintOneTemplate grid grid-cols-2">
        <div className="left col-span-1 ml-[50px] py-10">
            ...
            <div className='mt-20'>
                ...
                <input type="number" className="border border-[#009EE2] text-sm rounded-lg block w-full p-2.5" placeholder="30" min="0" max="30" value={inputValue} onChange={handleInputChange}/>
                </div>
            </div>
            ...
            <div className='mt-20'>
                ...
                <div className='input-content flex items-center'>
                    <input type="number" className="border border-[#009EE2] text-sm rounded-lg block w-full p-2.5" placeholder="1" min = "1" max="31"/>
                </div>
            </div>
