...
export const PrintThreeTemplate = () => {
    ...
    <div className="PrintOneTemplate grid grid-cols-2">
        ...
        <div className="flex items-center mt-16 gap-4">
            <input type="checkbox" value="True" checked={data.threeIsPaid} name="threeIsPaid" onChange={handleChange} className="w-14 h-14 text-blue-600 bg-white border border-[#009EE2]"/>
